<ul id="menu">
				...
				<li><a href="#" title="First comic"><img src="<?php bloginfo('template_url'); ?>/img/skin/btn-first.png"/></a></li>
				<li>
				...
				<li><a href="#" title="Last"><img src="<?php bloginfo('template_url'); ?>/img/skin/btn-last.png"/></a></li>
			</ul>